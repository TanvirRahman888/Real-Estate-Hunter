...
const LogIn = () => {
    ...
    const handelLogInForm = (e) => {
        ...
        signIn(email, password)
            ...
            .catch(error => {
                console.error(error);
                toast("Email and Password is not matched");
            })
    }
        ...
        <div className="">
            <div className="max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-50 dark:text-gray-800 w-1/2 bg-slate-100 mx-auto my-32">
                ...
                <form onSubmit={handelLogInForm} className="space-y-6">
                    ...
                    <button className="bg-blue-200 hover:bg-blue-300 font-bold text-lg py-3 block w-full p-3 text-center rounded-sm dark:text-gray-50 dark:bg-violet-600">Log In</button>
                </form>
